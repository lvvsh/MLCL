...
def main():
    ...
    parser.add_argument('--project_name', default='WHU-CD_SEIFNet_ce_Adamw_0.0001_200', type=str)
    ...
    parser.add_argument('--loss_SD', default=False, type=str2bool)  # 只有CD_Net才为True
    ...
    total = sum([param.nelement() for param in model.net_G.parameters()])
