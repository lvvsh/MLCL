...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    if args.net_G == 'MLCLNet':
        net = MLCLNet(args, input_nc=3, output_nc=2) #最终版的网络
...
class MLCLNet(Backbone):
    ...
    def __init__(self, args, input_nc, output_nc,
                 ...
                 Building_Bool=False):
        super(MLCLNet, self).__init__(args, input_nc, output_nc)
    ...
    def forward(self, x1, x2,x3, x4,DL12):
        ...
        tdl12 = torch.abs(x1_0 - x2_0)

        xdl1_2_1 = self.avgpool(xdl12_0)
